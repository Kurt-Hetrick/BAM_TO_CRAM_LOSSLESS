...
SCRIPT_REPO=/isilon/sequencing/Kurt/GIT_REPO/BAM_TO_CRAM_LOSSLESS/COMPRESSION_SCRIPTS
DEFAULT_REF_GENOME=/isilon/sequencing/GATK_resource_bundle/1.5/b37/human_g1k_v37_decoy.fasta

QUEUE_LIST=`qstat -f -s r | egrep -v "^[0-9]|^-|^queue" | cut -d @ -f 1 | sort | uniq | egrep -v "bigmem.q|all.q|cgc.q|programmers.q|lemon.q|uhoh.q|rhel7.q|qtest.q" | datamash collapse 1 | awk '{print "-q",$1}'`
